...
function createToggleTimeupdate() {
    ...
    return function(c, d, e) {
        !a && e ? a = setInterval(function() {
            document.body.contains(d.pluginElement) ? mejs.YouTubeApi.createEvent(c, d, "timeupdate") : b()
        }, 250) : a && !e && b()
    }
}
...
function constrainedSeekTo(a, b, c) {
    if (!isNaN(b.duration) && b.duration > 0) {
        a.isVideo && (a.showControls(),
        a.startControlsTimer());
        var d = Math.min(Math.max(0, c), b.duration);
        b.setCurrentTime(d)
    }
}
var mejs = mejs || {};
...
mejs.HtmlMediaElementShim = {
    ...
    createErrorMessage: function(a, b, c) {
        ...
        f += "<span>" + mejs.i18n.t("mejs.download-file") + "</span></a>"),
        e.innerHTML = f,
    ...
    createPlugin: function(a, b, c, d, e, f) {
        ...
        "flash" === a.method || "silverlight" === a.method) {
            var r = "audio/mp4" === j.getAttribute("type")
              , s = j.getElementsByTagName("source");
            if (s && !r)
                for (var p = 0, t = s.length; t > p; p++)
                    "audio/mp4" === s[p].getAttribute("type") && (r = !0);
        ...
        case "youtube":
            ...
            if (-1 != a.url.lastIndexOf("youtu.be"))
                u = a.url.substr(a.url.lastIndexOf("/") + 1),
                -1 != u.indexOf("?") && (u = u.substr(0, u.indexOf("?")));
            else {
                var v = a.url.match(/[?&]v=([^&#]+)|&|#|$/);
                v && (u = v[1])
            }
            youtubeSettings = {
                ...
                width: k,
                scheme: a.scheme,
                playerVars: b.youtubePlayerVars
            },
        ...
        case "vimeo":
            ...
            o.innerHTML = '<iframe src="' + a.scheme + "player.vimeo.com/video/" + n.vimeoid + "?api=1&portrait=0&byline=0&title=0&player_id=" + w + '" width="' + k + '" height="' + l + '" frameborder="0" class="mejs-shim" id="' + w + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
            "function" == typeof $f) {
                var x = $f(o.childNodes[0])
                  , y = -1;
                x.addEvent("ready", function() {
                    ...
                    x.setMuted = function(a) {
                        a ? (x.lastVolume = x.api("getVolume"),
                        x.api("setVolume", 0)) : (x.api("setVolume", x.lastVolume),
                        delete x.lastVolume)
                    }
                    ,
...
mejs.YouTubeApi = {
          ...
          , c = new YT.Player(a.containerId,{
            ...
            events: {
                onReady: function(d) {
                    ...
                    mejs.YouTubeApi.createEvent(c, b, "loadstart"),
                    mejs.YouTubeApi.createEvent(c, b, "canplay"),
                    mejs.YouTubeApi.createEvent(c, b, "loadedmetadata");
                    var e = a.pluginMediaElement.pluginApi.seekTo.bind(c);
                    a.pluginMediaElement.pluginApi.seekTo = function(a, d) {
                        e(a, d),
                        setTimeout(function() {
                            mejs.YouTubeApi.createEvent(c, b, "seeked"),
                            mejs.YouTubeApi.createEvent(c, b, "timeupdate")
                        }, 100)
                    }
                    ,
                    "undefined" != typeof b.attributes.autoplay && c.playVideo();
                    var f = c.setVolume.bind(c);
                    c.setVolume = function(a) {
                        f(a),
                        setTimeout(function() {
                            mejs.YouTubeApi.createEvent(c, b, "volumechange")
                        }, 100)
                    }
                },
    ...
    flashReady: function(a) {
        ...
        mejs.YouTubeApi.createEvent(c, d, "loadstart"),
    ...
    handleStateChange: function(a, b, c) {
        ...
        case YT.PlayerState.UNSTARTED:
            c.paused = !0,
            c.ended = !0,
            mejs.YouTubeApi.createEvent(b, c, "unstarted"),
            mejs.YouTubeApi.toggleTimeupdates(b, c, !1);
            break;
        ...
        case YT.PlayerState.PLAYING:
            ...
            mejs.YouTubeApi.toggleTimeupdates(b, c, !0);
            break;
    ...
    var e = {
        ...
        t: function(a, b) {
            if ("string" == typeof a && a.length) {
                ...
                return e.locale.strings && e.locale.strings[f] && (c = e.locale.strings[f][a],
                "number" == typeof b && (d = e.locale.strings[f]["mejs.plural-form"],
                c = g.apply(null, [c, b, d]))),
                !c && e.locale.strings && e.locale.strings[e["default"]] && (c = e.locale.strings[e["default"]][a],
                "number" == typeof b && (d = e.locale.strings[e["default"]]["mejs.plural-form"],
                c = g.apply(null, [c, b, d]))),
                c = c || a,
                "number" == typeof b && (c = c.replace("%1", b)),
                h(c)
            }
            return a
        }
    };
    "undefined" != typeof mejsL10n && (e.locale.language = mejsL10n.language),
    c.i18n = e
...
function(a) {
    mejs.MepDefaults = {
        ...
        defaultJumpBackwardInterval: function(a) {
            return .05 * a.duration
        },
        defaultJumpForwardInterval: function(a) {
            return .05 * a.duration
        },
        setDimensions: !0,
        audioWidth: -1,
        ...
        keyActions: [{
            ...
            keys: [33],
            action: function(a, b) {
                var c = b.currentTime + a.options.defaultJumpBackwardInterval(b);
                constrainedSeekTo(a, b, c)
            }
        }, {
            keys: [34],
            action: function(a, b) {
                var c = b.currentTime + a.options.defaultJumpForwardInterval(b);
                constrainedSeekTo(a, b, c)
            }
        }, {
            keys: [70],
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function() {
            ...
            c.isiPad && b.options.iPadUseNativeControls || c.isiPhone && b.options.iPhoneUseNativeControls)
                ...
                ;
            else if (b.isVideo || !b.isVideo && b.options.features.length) {
                b.$media.removeAttr("controls");
                var f = b.isVideo ? mejs.i18n.t("mejs.video-player") : mejs.i18n.t("mejs.audio-player");
                b.options.titleText && (f = b.options.titleText),
                a('<span class="mejs-offscreen">').text(f).insertBefore(b.$media),
                ...
                b.isVideo || b.options.features.length || b.$media.hide();
            mejs.MediaElement(b.$media[0], d),
            "undefined" != typeof b.container && b.options.features.length && b.controlsAreVisible && b.container.trigger("controlsshown")
        },
        ...
        hideControls: function(b) {
            ...
            !c.controlsAreVisible || c.options.alwaysShowControls || c.keyboardAction || c.media.paused || c.media.ended || (b ? (c.controls.stop(!0, !0).fadeOut(200, function() {
        ...
        startControlsTimer: function(a) {
            var b = this;
            a = "undefined" != typeof a ? a : b.options.controlsTimeoutDefault,
        ...
        meReady: function(b, c) {
            ...
            if (!f.created) {
                ...
                !(g.isAndroid && f.options.AndroidUseNativeControls || g.isiPad && f.options.iPadUseNativeControls || g.isiPhone && f.options.iPhoneUseNativeControls)) {
                    if (!f.isVideo && !f.options.features.length)
                        return i && "native" == b.pluginType && f.play(),
                    ...
                    f.isVideo && (mejs.MediaFeatures.hasTouch && !f.options.alwaysShowControls ? f.$media.bind("touchstart", function() {
                        ...
                        if (f.options.clickToPlayPause) {
                            ...
                            var a = f.$media.closest(".mejs-container").find(".mejs-overlay-button")
                    ...
                    f.container.bind("mouseenter", function() {
                        ...
                        f.showControls(),
                        f.startControlsTimer(f.options.controlsTimeoutMouseEnter)))
                    }).bind("mousemove", function() {
                        f.controlsEnabled && (f.options.alwaysShowControls || (f.showControls(),
                        f.startControlsTimer(f.options.controlsTimeoutMouseEnter)))
                    ...
                    f.controls.on("focusin", function() {
                        f.controlsEnabled && (f.options.alwaysShowControls || f.showControls())
                    })),
                    ...
                    f.media.addEventListener("ended", function(b) {
                        ...
                        "youtube" === f.media.pluginType ? f.media.stop() : f.media.pause(),
                    ...
                    f.media.addEventListener("loadedmetadata", function() {
        ...
        setControlsSize: function() {
            var b = this
              ...
              , g = e.siblings().filter(":visible")
              , h = g.last()
              , i = null
              , j = b.options && !b.options.autosizeProgress;
            if (b.container.is(":visible") && e.length && e.is(":visible")) {
                j && (d = parseInt(e.css("width"), 10)),
                0 !== d && d || (g.each(function() {
                    var b = a(this);
                    "absolute" != b.css("position") && (c += a(this).outerWidth(!0))
                }),
        ...
        buildposter: function(b, c, d, e) {
            ...
            e.addEventListener("play", function() {
                b.options.hidePosterOnPlay && g.hide()
            }, !1),
        ...
        buildoverlays: function(b, c, d, e) {
            ...
            if (b.isVideo) {
                var g = a('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(d)
                  ...
                  , i = a('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button" role="button" aria-label="' + mejs.i18n.t("mejs.play") + '" aria-pressed="false"></div></div>').appendTo(d).bind("click", function() {
                    if (f.options.clickToPlayPause) {
                        e.paused && e.play();
                        var b = a(this).find(".mejs-overlay-button")
                          , c = b.attr("aria-pressed");
        ...
        buildkeyboard: function(b, c, d, e) {
            ...
            f.globalBind("keydown", function(c) {
                return b.hasFocus = 0 !== a(c.target).closest(".mejs-container").length && 0 === a(c.target).closest(".mejs-keyboard-insulator").length && a(c.target).closest(".mejs-container").attr("id") === b.$media.closest(".mejs-container").attr("id"),
                f.onkeydown(b, e, c)
            }),
            f.globalBind("click", function(c) {
                b.hasFocus = 0 !== a(c.target).closest(".mejs-container").length && 0 === a(c.target).closest(".mejs-keyboard-insulator").length
            })
        },
            ...
            if ("youtube" === b.media.pluginType) {
                ...
                if ("string" != typeof a) {
                    ...
                    for (d = 0; d < a.length; d++)
                        if (e = a[d],
                        this.canPlayType(e.type)) {
                            a = e.src;
                            break
                        }
                }
                if (-1 !== a.lastIndexOf("youtu.be"))
                    c = a.substr(a.lastIndexOf("/") + 1),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildplaypause: function(b, c, d, e) {
            function f(a) {
                "play" === a ? (k.removeClass("mejs-play").addClass("mejs-pause"),
                l.attr({
                    title: j,
                    "aria-label": j
                })) : (k.removeClass("mejs-pause").addClass("mejs-play"),
                l.attr({
                    title: i,
                    "aria-label": i
                }))
            ...
            var g = this
              , h = g.options
              , i = h.playText ? h.playText : mejs.i18n.t("mejs.play")
              , j = h.pauseText ? h.pauseText : mejs.i18n.t("mejs.pause")
              , k = a('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="' + g.id + '" title="' + i + '" aria-label="' + j + '"></button></div>').appendTo(c).click(function(a) {
            ...
            f("pse"),
            e.addEventListener("play", function() {
                g.options.playbackRate && (e.playbackRate = g.options.playbackRate),
                f("play")
            }, !1),
            e.addEventListener("playing", function() {
                f("play")
            ...
            e.addEventListener("unstarted", function() {
                f("pse")
            }, !1)
        }
    })
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function(b, c, d, e) {
            var f = this
              ...
              , i = 0
              , j = !1
              , k = b.options.autoRewind
              , l = (f.options.progressHelpText ? f.options.progressHelpText : mejs.i18n.t("mejs.time-help-text"),
            ...
            c.find(".mejs-time-buffering").hide(),
            f.total = c.find(".mejs-time-total"),
            f.loaded = c.find(".mejs-time-loaded"),
            f.current = c.find(".mejs-time-current"),
            f.handle = c.find(".mejs-time-handle"),
            f.timefloat = c.find(".mejs-time-float"),
            f.timefloatcurrent = c.find(".mejs-time-float-current"),
            ...
            var m = function(a) {
                ...
                e.duration && (c < d.left ? c = d.left : c > h + d.left && (c = h + d.left),
                k = c - d.left,
                i = k / h,
                j = i * e.duration,
                g && j !== e.currentTime && e.setCurrentTime(j),
                mejs.MediaFeatures.hasTouch || (f.timefloat.css("left", k),
                f.timefloatcurrent.html(mejs.Utility.secondsToTimeCode(j, b.options)),
                f.timefloat.show()))
            }
              , n = function(a) {
                f.slider.attr(p(e.duration, e.currentTime))
            }
              , o = function() {
                var a = new Date;
                a - i >= 1e3 && e.play()
              ...
              , p = function(a, c) {
                var d = mejs.i18n.t("mejs.time-slider")
                  , e = mejs.Utility.secondsToTimeCode(c, b.options);
                return {
                    "aria-label": d,
                    "aria-valuemin": 0,
                    "aria-valuemax": a,
            ...
            f.slider.bind("keydown", function(a) {
                ...
                var c = a.keyCode
                  , d = e.duration
                  , f = e.currentTime
                  , g = b.options.defaultSeekForwardInterval(e)
                  , h = b.options.defaultSeekBackwardInterval(e);
                switch (jumpForward = b.options.defaultJumpForwardInterval(e),
                jumpBackward = b.options.defaultJumpBackwardInterval(e),
                c) {
                case 37:
                case 40:
                    f -= h;
                ...
                i = new Date,
                j || e.pause(),
                f < e.duration && !j && setTimeout(o, 1100),
                e.setCurrentTime(f),
                a.preventDefault(),
                a.stopPropagation(),
                !1
            ...
            f.total.bind("mousedown touchstart", function(a) {
                ...
                f.globalBind("mouseup.dur touchend.dur", function(a) {
                    g = !1,
                    "undefined" != typeof f.timefloat && f.timefloat.hide(),
                    f.globalUnbind(".dur")
                }))
            ...
            f.container.on("controlsresize", function(a) {
                b.setProgressRail(a),
                b.setCurrentRail(a)
            })
        },
        setProgressRail: function(a) {
            var b = this
              ...
              , d = null
              , e = c && c.buffered;
            e && e.length > 0 && e.end && c.duration ? d = e.end(e.length - 1) / c.duration : c && void 0 !== c.bytesTotal && c.bytesTotal > 0 && void 0 !== c.bufferedBytes ? d = c.bufferedBytes / c.bytesTotal : a && a.lengthComputable && 0 !== a.total && (d = a.loaded / a.total),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildvolume: function(b, c, d, e) {
            function f() {
                return "function" == typeof e.getVolume ? e.getVolume() : e.volume
            }
            if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                var g = this
                  , h = g.isVideo ? g.options.videoVolume : g.options.audioVolume
                  , i = "horizontal" == h ? a('<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' + g.id + '" title="' + g.options.muteText + '" aria-label="' + g.options.muteText + '"></button></div><a href="javascript:void(0);" class="mejs-horizontal-volume-slider"><span class="mejs-offscreen">' + g.options.allyVolumeControlText + '</span><div class="mejs-horizontal-volume-total"></div><div class="mejs-horizontal-volume-current"></div><div class="mejs-horizontal-volume-handle"></div></a>').appendTo(c) : a('<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' + g.id + '" title="' + g.options.muteText + '" aria-label="' + g.options.muteText + '"></button><a href="javascript:void(0);" class="mejs-volume-slider mejs-offscreen"><span class="mejs-offscreen">' + g.options.allyVolumeControlText + '</span><div class="mejs-volume-total"></div><div class="mejs-volume-current"></div><div class="mejs-volume-handle"></div></a></div>').appendTo(c)
                  , j = g.container.find(".mejs-volume-slider, .mejs-horizontal-volume-slider")
                  , k = g.container.find(".mejs-volume-total, .mejs-horizontal-volume-total")
                  , l = g.container.find(".mejs-volume-current, .mejs-horizontal-volume-current")
                  , m = g.container.find(".mejs-volume-handle, .mejs-horizontal-volume-handle")
                  , n = function(a, b) {
                    if (!j.is(":visible") && "undefined" == typeof b)
                        return j.show(),
                        n(a, !0),
                        void j.hide();
                    if (j.hasClass("mejs-offscreen") && "undefined" == typeof b)
                        return j.removeClass("mejs-offscreen"),
                        n(a, !0),
                        void j.addClass("mejs-offscreen");
                    a = Math.max(0, a),
                    a = Math.min(a, 1),
                    0 === a ? (i.removeClass("mejs-mute").addClass("mejs-unmute"),
                    i.children("button").attr("title", mejs.i18n.t("mejs.unmute")).attr("aria-label", mejs.i18n.t("mejs.unmute"))) : (i.removeClass("mejs-unmute").addClass("mejs-mute"),
                    i.children("button").attr("title", mejs.i18n.t("mejs.mute")).attr("aria-label", mejs.i18n.t("mejs.mute")));
                    var c = k.position();
                    if ("vertical" == h) {
                        var d = k.height()
                          , e = d - d * a;
                        m.css("top", Math.round(c.top + e - m.height() / 2)),
                        l.height(d - e),
                        l.css("top", c.top + e)
                    } else {
                        var f = k.width()
                          , g = f * a;
                        m.css("left", Math.round(c.left + g - m.width() / 2)),
                        l.width(Math.round(g))
                    }
                }
                  , o = function(a) {
                    var b = null
                  ...
                  , q = !1;
                i.hover(function() {
                    j.removeClass("mejs-offscreen"),
                    q = !0
                }, function() {
                    q = !1,
                    p || "vertical" != h || j.addClass("mejs-offscreen")
                });
                var r = function(a) {
                    var b = Math.floor(100 * f(e));
                    j.attr({
                  ...
                  , s = mejs.Utility.debounce(function(b) {
                    setTimeout(function() {
                        var b = a(document.activeElement).closest(".mejs-mute");
                        b.length || q || "vertical" != h || j.addClass("mejs-offscreen")
                    }, 0)
                }, 100);
                j.bind("mouseover", function() {
                    ...
                    g.globalBind("mouseup.vol", function() {
                        p = !1,
                        g.globalUnbind(".vol"),
                        q || "vertical" != h || j.addClass("mejs-offscreen")
                    }),
                    p = !0,
                    !1
                ...
                e.addEventListener("volumechange", function(a) {
                    p || (e.muted ? (n(0),
                    i.removeClass("mejs-mute").addClass("mejs-unmute")) : (n(f()),
                    i.removeClass("mejs-unmute").addClass("mejs-mute"))),
                    r(a)
                }, !1),
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildfullscreen: function(b, c, d, e) {
            if (b.isVideo) {
                ...
                var f = this
                  , g = null
                  , h = f.options.fullscreenText ? f.options.fullscreenText : mejs.i18n.t("mejs.fullscreen")
                  , i = a('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + f.id + '" title="' + h + '" aria-label="' + h + '" aria-live="assertive"></button></div>').appendTo(c).on("click", function() {
                ...
                if (b.fullscreenBtn = i,
                b.fullscreenBtn.setLabel = function(a) {
                    var c = mejs.i18n.t(a);
                    b.fullscreenBtn.find("button").attr("aria-label", c).attr("title", c)
                }
                ,
        ...
        enterFullScreen: function() {
            var b = this;
            if (mejs.MediaFeatures.isiOS && mejs.MediaFeatures.hasiOSFullScreen && "function" == typeof b.media.webkitEnterFullscreen)
            ...
            "native-native" === b.fullscreenMode || "plugin-native" === b.fullscreenMode ? mejs.MediaFeatures.requestFullScreen(b.container[0]) : "fullwindow" == b.fullscreeMode,
            ...
            b.setControlsSize(),
            b.isFullScreen = !0;
            var c = Math.min(screen.width / b.width, screen.height / b.height);
            b.container.find(".mejs-captions-text").css("font-size", 100 * c + "%"),
            b.container.find(".mejs-captions-text").css("line-height", "normal"),
            b.container.find(".mejs-captions-position").css("bottom", "45px"),
            b.fullscreenBtn.setLabel("Exit Fullscreen"),
        ...
        exitFullScreen: function() {
            ...
            b.container.find(".mejs-captions-text").css("line-height", ""),
            b.container.find(".mejs-captions-position").css("bottom", ""),
            b.fullscreenBtn.setLabel("Enter Fullscreen"),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildspeed: function(b, c, d, e) {
            var f, g = this;
            if ("native" == g.media.pluginType) {
                for (var h = null, i = null, j = null, k = null, l = null, m = [], n = !1, o = 0, p = g.options.speeds.length; p > o; o++) {
                    var q = g.options.speeds[o];
                    "string" == typeof q ? (m.push({
                        name: q + g.options.speedChar,
                        value: q
                    }),
                    q === g.options.defaultSpeed && (n = !0)) : (m.push(q),
                    q.value === g.options.defaultSpeed && (n = !0))
                }
                n || m.push({
                    name: g.options.defaultSpeed + g.options.speedChar,
                    value: g.options.defaultSpeed
                }),
                m.sort(function(a, b) {
                ...
                var r = function(a) {
                  ...
                  , s = function(a) {
                    return mejs.i18n.t(g.options.speedLabel + ": Current speed " + r(a))
                }
                  , t = '<div class="mejs-button mejs-speed-button"><button role="button" aria-haspopup="true" aria-controls="' + g.id + '" type="button" aria-label="' + s(g.options.defaultSpeed) + '" aria-live="assertive">' + r(g.options.defaultSpeed) + '</button><div class="mejs-speed-selector mejs-offscreen" role="menu" aria-expanded="false" aria-hidden="true"><ul>';
                for (o = 0,
                il = m.length; o < il; o++)
                    k = g.id + "-speed-" + m[o].value,
                    l = m[o].value === g.options.defaultSpeed,
                    t += '<li><input type="radio" name="speed" role="menuitemradio"value="' + m[o].value + '" id="' + k + '" ' + (l ? ' checked="checked"' : "") + ' aria-selected="' + l + '" aria-label="' + r(m[o].value) + '" tabindex="-1" /><label for="' + k + '" aria-hidden="true"' + (l ? ' class="mejs-speed-selected"' : "") + ">" + m[o].name + "</label></li>";
                t += "</ul></div></div>",
                b.speedButton = h = a(t).appendTo(c),
                i = h.find(".mejs-speed-selector"),
                j = g.options.defaultSpeed,
                e.addEventListener("loadedmetadata", function(a) {
                    j && (e.playbackRate = parseFloat(j))
                }, !0),
                i.on("click", 'input[type="radio"]', function() {
                    a(this).attr("aria-selected", !0).attr("checked", "checked"),
                    a(this).closest(".mejs-speed-selector").find("input[type=radio]").not(this).attr("aria-selected", "false").removeAttr("checked");
                    var b = a(this).attr("value");
                    j = b;
                    var c = parseFloat(b);
                    e.playbackRate = c,
                    g.options.playbackRate = c,
                    h.find("button").html(r(b)).attr("aria-label", s(b)),
                    h.find(".mejs-speed-selected").removeClass("mejs-speed-selected"),
                    h.find('input[type="radio"]:checked').next().addClass("mejs-speed-selected")
                }),
                h.one("mouseenter focusin", function() {
                    i.height(h.find(".mejs-speed-selector ul").outerHeight(!0) + h.find(".mejs-speed-translations").outerHeight(!0)).css("top", -1 * i.height() + "px")
                }).hover(function() {
                    clearTimeout(f),
                    b.showSpeedSelector()
                }, function() {
                    f = setTimeout(function() {
                        b.hideSpeedSelector()
                    }, g.options.menuTimeoutMouseLeave)
                }).on("keydown", function(c) {
                    var d = c.keyCode;
                    switch (d) {
                    case 32:
                        mejs.MediaFeatures.isFirefox || b.showSpeedSelector(),
                        a(this).find(".mejs-speed-selector").find("input[type=radio]:checked").first().focus();
                        break;
                    case 13:
                        b.showSpeedSelector(),
                        a(this).find(".mejs-speed-selector").find("input[type=radio]:checked").first().focus();
                    ...
                    setTimeout(function() {
                        var c = a(document.activeElement).closest(".mejs-speed-selector");
                        c.length || b.hideSpeedSelector()
                    }, 0)
                }, 100)).on("click", "button", function(c) {
                    a(this).siblings(".mejs-speed-selector").hasClass("mejs-offscreen") ? (b.showSpeedSelector(),
                    a(this).siblings(".mejs-speed-selector").find("input[type=radio]:checked").first().focus()) : b.hideSpeedSelector()
                })
            }
        },
        hideSpeedSelector: function() {
            this.speedButton.find(".mejs-speed-selector").addClass("mejs-offscreen").attr("aria-expanded", "false").attr("aria-hidden", "true").find("input[type=radio]").attr("tabindex", "-1")
        },
        showSpeedSelector: function() {
            this.speedButton.find(".mejs-speed-selector").removeClass("mejs-offscreen").attr("aria-expanded", "true").attr("aria-hidden", "false").find("input[type=radio]").attr("tabindex", "0")
        }
    })
}(mejs.$),
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(b, c, d, e) {
            if (0 !== b.tracks.length) {
                ...
                if (h.domNode.textTracks)
                    for (f = h.domNode.textTracks.length - 1; f >= 0; f--)
                        h.domNode.textTracks[f].mode = "hidden";
                h.cleartracks(b, c, d, e),
                ...
                b.captionsButton = a('<div class="mejs-button mejs-captions-button"><button type="button" aria-controls="' + h.id + '" title="' + j + '" aria-label="' + j + '"></button><div class="mejs-captions-selector mejs-offscreen" role="menu" aria-expanded="false" aria-hidden="true"><ul><li><input type="radio" name="' + b.id + '_captions" id="' + b.id + '_captions_none" value="none" checked="checked" role="menuitemradio" aria-selected="true" aria-label="' + mejs.i18n.t("mejs.none") + '" tabindex="-1" /><label for="' + b.id + '_captions_none" aria-hidden="true">' + mejs.i18n.t("mejs.none") + "</label></li></ul></div></div>").appendTo(c);
                var k = 0;
                for (f = 0; f < b.tracks.length; f++)
                    g = b.tracks[f].kind,
                    ("subtitles" === g || "captions" === g) && k++;
                if (h.options.toggleCaptionsButtonWhenOnlyOne && 1 == k)
                    ...
                    b.captionsButton.hover(function() {
                        clearTimeout(l),
                        b.showCaptionsSelector()
                    }, function() {
                        l = setTimeout(function() {
                            b.hideCaptionsSelector()
                        }, h.options.menuTimeoutMouseLeave)
                    }).on("keydown", function(c) {
                        var d = c.keyCode;
                        switch (d) {
                        case 32:
                            mejs.MediaFeatures.isFirefox || b.showCaptionsSelector(),
                            a(this).find(".mejs-captions-selector").find("input[type=radio]:checked").first().focus();
                            break;
                        case 13:
                            b.showCaptionsSelector(),
                            a(this).find(".mejs-captions-selector").find("input[type=radio]:checked").first().focus();
                        ...
                        setTimeout(function() {
                            var c = a(document.activeElement).closest(".mejs-captions-selector");
                            c.length || b.hideCaptionsSelector()
                        }, 0)
                    }, 100)).on("click", "input[type=radio]", function() {
                        lang = this.value,
                        b.setTrack(lang)
                    }).on("click", "button", function() {
                        a(this).siblings(".mejs-captions-selector").hasClass("mejs-offscreen") ? (b.showCaptionsSelector(),
                        a(this).siblings(".mejs-captions-selector").find("input[type=radio]:checked").first().focus()) : b.hideCaptionsSelector()
                    })
                }
                for (b.options.alwaysShowControls ? b.container.find(".mejs-captions-position").addClass("mejs-captions-position-hover") : b.container.bind("controlsshown", function() {
        ...
        hideCaptionsSelector: function() {
            this.captionsButton.find(".mejs-captions-selector").addClass("mejs-offscreen").attr("aria-expanded", "false").attr("aria-hidden", "true").find("input[type=radio]").attr("tabindex", "-1")
        },
        showCaptionsSelector: function() {
            this.captionsButton.find(".mejs-captions-selector").removeClass("mejs-offscreen").attr("aria-expanded", "true").attr("aria-hidden", "false").find("input[type=radio]").attr("tabindex", "0")
        },
        setTrackAriaLabel: function() {
            var a = this.options.tracksText
              , b = this.selectedTrack;
            b && (a += ": " + b.label),
            this.captionsButton.find("button").attr("aria-label", a).attr("title", a)
        },
        setTrack: function(b) {
            var c, d = this;
            if (a(this).attr("aria-selected", !0).attr("checked", "checked"),
            a(this).closest(".mejs-captions-selector").find("input[type=radio]").not(this).attr("aria-selected", "false").removeAttr("checked"),
            "none" == b)
                d.selectedTrack = null,
                d.captionsButton.removeClass("mejs-captions-enabled");
            else
                for (c = 0; c < d.tracks.length; c++)
                    if (d.tracks[c].srclang == b) {
                        null === d.selectedTrack && d.captionsButton.addClass("mejs-captions-enabled"),
                        d.selectedTrack = d.tracks[c],
                        d.captions.attr("lang", d.selectedTrack.srclang),
                        d.displayCaptions();
                        break
                    }
            d.setTrackAriaLabel()
        ...
        enableTrackButton: function(b, c) {
            ...
            d.captionsButton.find("input[value=" + b + "]").prop("disabled", !1).attr("aria-label", c).siblings("label").html(c),
        ...
        displayCaptions: function() {
            if ("undefined" != typeof this.tracks) {
                var a, b = this, c = b.selectedTrack, d = function(a) {
                    parser = new DOMParser,
                    doc = parser.parseFromString(a, "text/html");
                    for (var b = ["i", "b", "u", "v", "c", "ruby", "rt", "lang", "link"], c = Array.from(doc.body.children || []); c.length; ) {
                        var d = c.shift();
                        b.includes(d.tagName.toLowerCase()) ? c = c.concat(Array.from(d.children || [])) : d.parentNode.removeChild(d)
                    }
                    for (var e = doc.body.getElementsByTagName("*"), f = 0, g = e.length; g > f; f++)
                        for (var h = e[f].attributes, i = Array.prototype.slice.call(h), j = 0, k = i.length; k > j; j++)
                            i[j].name.startsWith("on") || i[j].value.startsWith("javascript") ? e[f].parentNode.removeChild(e[f]) : "style" === i[j].name && e[f].removeAttribute(i[j].name);
                ...
                if (null !== c && c.isLoaded) {
                    for (a = 0; a < c.entries.times.length; a++)
                        if (b.media.currentTime >= c.entries.times[a].start && b.media.currentTime <= c.entries.times[a].stop)
                            return b.captionsText.html(d(c.entries.text[a])).attr("class", "mejs-captions-text " + (c.entries.times[a].identifier || "")),
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        ...
        buildsourcechooser: function(b, c, d, e) {
            ...
            b.sourcechooserButton = a('<div class="mejs-button mejs-sourcechooser-button"><button type="button" role="button" aria-haspopup="true" aria-controls="' + g.id + '" title="' + h + '" aria-label="' + h + '" aria-live="assertive"></button><div class="mejs-sourcechooser-selector mejs-offscreen" role="menu" aria-expanded="false" aria-hidden="true"><ul></ul></div></div>').appendTo(c).hover(function() {
                clearTimeout(f),
                b.showSourcechooserSelector()
            }, function() {
                f = setTimeout(function() {
                ...
                switch (d) {
                case 32:
                    mejs.MediaFeatures.isFirefox || b.showSourcechooserSelector(),
                    a(this).find(".mejs-sourcechooser-selector").find("input[type=radio]:checked").first().focus();
                    break;
                case 13:
                    b.showSourcechooserSelector(),
                    a(this).find(".mejs-sourcechooser-selector").find("input[type=radio]:checked").first().focus();
                ...
                a(this).attr("aria-selected", !0).attr("checked", "checked"),
                a(this).closest(".mejs-sourcechooser-selector").find("input[type=radio]").not(this).attr("aria-selected", "false").removeAttr("checked");
                var b = this.value;
                if (e.currentSrc != b) {
                    var c = e.currentTime
                      , d = e.paused;
                    ...
                    var f = function(a) {
                        d || e.play(),
                        e.removeEventListener("canplay", f, !0)
                    };
                    e.addEventListener("canplay", f, !0),
                    e.load()
                }
                g.setSourcechooserAriaLabel(e)
            ...
            for (var i in this.node.children) {
                ...
                "SOURCE" !== j.nodeName || "probably" != e.canPlayType(j.type) && "maybe" != e.canPlayType(j.type) || (g.sources.push(j),
                b.addSourceButton(j.src, j.title, j.type, e.src == j.src))
            }
            g.setSourcechooserAriaLabel(e)
        },
        setSourcechooserAriaLabel: function(a) {
            var b = this.options.sourcechooserText ? this.options.sourcechooserText : mejs.i18n.t("mejs.source-chooser")
              , c = this.currentSource(a);
            c && (b += ": " + c),
            this.sourcechooserButton.find("button").attr("aria-label", b).attr("title", b)
        },
        addSourceButton: function(b, c, d, e) {
            var f = this;
            ("" === c || void 0 == c) && (c = b),
            d = d.split("/")[1],
            f.sourcechooserButton.find("ul").append(a('<li><input type="radio" name="' + f.id + '_sourcechooser" id="' + f.id + "_sourcechooser_" + c + d + '" role="menuitemradio" value="' + b + '" ' + (e ? 'checked="checked"' : "") + 'aria-selected="' + e + '" aria-label="' + c + '" tabindex="-1" /><label for="' + f.id + "_sourcechooser_" + c + d + '" aria-hidden="true">' + c + " (" + d + ")</label></li>")),
            f.adjustSourcechooserBox()
        },
        currentSource: function(a) {
            var b = this.sources.filter(function(b) {
                return b.src == a.src
            })[0];
            return b ? b.title || "" : ""
        },
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildskipback: function(b, c, d, e) {
            var f = this
              , g = mejs.i18n.t("mejs.time-skip-back", f.options.skipBackInterval)
              , h = f.options.skipBackText ? f.options.skipBackText : g;
...
function(a) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildpostroll: function(b, c, d, e) {
            var f = this
              , g = f.options.postrollCloseText ? f.options.postrollCloseText : mejs.i18n.t("mejs.close")
              , h = f.container.find('link[rel="postroll"]').attr("href");
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildmarkers: function(a, b, c, d) {
            var e = 0
              ...
              , h = -1
              , i = -1;
            for (e = 0; e < a.options.markers.length; ++e)
                b.find(".mejs-time-total").append('<span class="mejs-time-marker"></span>');
            ...
            d.addEventListener("timeupdate", function(b) {
                ...
                h > f ? i > f && (i = -1) : h = f,
                e = 0; e < a.options.markers.length; ++e)
                    g = Math.floor(a.options.markers[e]),
        ...
        setmarkers: function(b) {
            var c, d = this, e = 0;
            for (e = 0; e < d.options.markers.length; ++e)
                Math.floor(d.options.markers[e]) <= d.media.duration && Math.floor(d.options.markers[e]) >= 0 && (c = 100 * Math.floor(d.options.markers[e]) / d.media.duration,
