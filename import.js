(function(){
	...
	document.writeln("<script type='text/javascript' src='"+APIURL+"components/youtube.js'></script>");	//	youtube 異붽� 
	document.writeln("<script type='text/javascript' src='"+APIURL+"components/imageSlider.js'></script>");	//	�щ씪�대뱶 �대�吏�
